...
import { attendanceByDate, copyAttendance, exportAttendance, lowAttendance, lowAttendanceExport, searchStudents } from "../controllers/attendanceReports.js";
...
export default function routes() {
  const router = Router(); router.use("/auth", authRoutes); router.get("/students/search", protect, searchStudents); router.use("/students", resource(students)); router.use("/subjects", resource(subjects));
  router.get("/attendance/date", protect, attendanceByDate); router.get("/attendance/low", protect, lowAttendance); router.get("/attendance/export", protect, exportAttendance); router.get("/attendance/low/export", protect, lowAttendanceExport); router.post("/attendance/copy", protect, copyAttendance);
